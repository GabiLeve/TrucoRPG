...
{
    /// <inheritdoc />
    public partial class ResetInicialMinusculas : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "items",
                columns: new[] { "id", "acumulable", "categoria", "descripcion", "img", "nombre", "precio", "spritekey" },
                values: new object[,]
                {
                    { 1, false, "HABILIDADES", "Te otorga la habilidad del manipulador en una partida", "/assets/objetos/objeto.png", "BOLEADORAS", 150, null },
                    { 2, false, "HABILIDADES", "Te otorga la habilidad del timbero en una partida", "/assets/objetos/objeto.png", "BOLEADORAS", 150, null },
                    { 3, false, "HABILIDADES", "Te otorga la habilidad del fanfarron en una partida", "/assets/objetos/objeto.png", "BOLEADORAS", 150, null },
                    { 4, false, "HABILIDADES", "Te otorga la habilidad del mentiroso en una partida", "/assets/objetos/objeto.png", "BOLEADORAS", 150, null },
                    { 5, false, "ARMARIO", "Cambia el color de tu Poncho a rosa", "/assets/objetos/GotaRosa.png", "Poncho rosa", 150, "personaje1rosa" },
                    { 6, false, "ARMARIO", "Cambia el color de tu Poncho a marrón", "/assets/objetos/GotaMarron.png", "Poncho marrón", 150, "personaje1rosa" },
                    { 7, false, "ARMARIO", "Cambia el color de tu Poncho a rojo", "/assets/objetos/GotaRoja.png", "Poncho rojo", 150, "personaje1rosa" },
                    { 8, false, "ARMARIO", "Cambia el color de tu Poncho a azul", "/assets/objetos/GotaAzul.png", "Poncho azul", 150, "personaje1rosa" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa4"), "Cuarto jefe de la historia. Una presencia luminosa que desorienta al viajero.", "Destello: cada 2 turnos en bazas 1 o 2, te obliga a jugar una carta al azar. Espejismo (pasiva): si es mano y abre la baza 1, muestra una carta falsa en pantalla hasta que respondas.", 4, "La Luz Mala", "Destello", 5, 4 },
                    { new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa5"), "Jefe final de la historia. Domina el trono con tres fases de combate.", "Fase I (siempre): cada 2 manos maldice la mesa. Fase II (10+ pts tuyos): El Engaño. Fase III (20+ pts tuyos): El Espejo.", 5, "Mandinga", "Fases", 6, 5 }
                });
