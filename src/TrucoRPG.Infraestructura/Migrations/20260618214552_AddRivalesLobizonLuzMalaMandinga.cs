    ...
    public partial class AddRivalesLobizonLuzMalaMandinga : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa3"), "Tercer jefe de la historia. Acecha en las profundidades de la cueva.", "Cada 2 manos, debilita 1 carta aleatoria bajando su valor en 1 (ej. 1 de Espada pasa a 1 de Basto, un 3 pasa a un 2).", 3, "El Lobizón", "Rasguño", 3, 3 },
