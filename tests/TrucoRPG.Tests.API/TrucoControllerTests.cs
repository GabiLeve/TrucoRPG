...
public class TrucoControllerTests
{
    ...
    private static TrucoController CrearController() => new(
        ...
        new ConfirmarDestelloUseCase(),
        new ConfirmarEspejismoUseCase(),
        new ConfirmarMandingaEspejoUseCase(),
        new ConfirmarMandingaEnganoUseCase(),
        new ConfirmarMandingaMaldicionUseCase(),
        new AvanzarMaquinaHistoriaUseCase(),
        new GanarAutomaticoDebugUseCase(),
        new SumarPuntosHumanoDebugUseCase(),
